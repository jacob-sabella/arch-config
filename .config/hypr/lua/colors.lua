-- Matugen-generated palette. Single source of truth for theme colors.
-- Exposed as a global table `M` so other modules can use M.colors.primary etc.
...
M.colors = {
  ...
  on_tertiary_container       = "rgba(ffdeacff)",
